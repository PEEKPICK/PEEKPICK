  ...
  return (
    <div className={classes.side}>
      ...
      <div className={classes.noticecontent}>
        ...
        {contentVisible[1] && <div className={classes.content}>데이터 전달 로직 수정중..</div>}
      </div>
      <div className={classes.noticecontent}>
        <div className={classes.noticeitem}>
        ...
        {contentVisible[2] && <div className={classes.content}>이게 왜 안돼..?</div>}
      </div>
      <div className={classes.noticecontent}>
        <div className={classes.noticeitem}>
      ...
      <div className={classes.noticecontent}>
        <div className={classes.noticeitem}>
          <span className={classes.noticedate}>2023년 8월 16일</span>
          <div className={classes.noticetextimg}>
            <p className={classes.noticetext}>App.Ver</p>
            {contentVisible[4] ? (
              <img
                src="img/up.png"
                alt=""
